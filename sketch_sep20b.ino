...
unsigned char *plogoActuel;
const unsigned char TVOlogo[32][4]  = {
    {0x00,0x00,0x00,0x00},
    {0x10,0x20,0x08,0x78},
    {0x10,0x20,0x08,0x40},
    {0x9C,0x27,0xCE,0x43},
...
const unsigned char  TVOlogo2[32][4] = {
    {0xFF,0x01,0x00,0x00},
    {0x0F,0x03,0x00,0x00},
    {0x07,0xE7,0x03,0x00},
    {0x07,0x3C,0x0E,0x00},
...
void setup() {
    ...
    //Serial.begin(9600);
    plogoActuel = (unsigned char*) &TVOlogo;
    
}
/** Loop */
void loop() {
    
    //Serial.println((int)plogoActuel);
    //Serial.println((int)&TVOlogo);
    ...
    unsigned char reste = x%8;
    unsigned char xprime = (x-reste)/8;
    unsigned char valeur = *(plogoActuel+(y*4+xprime));
    unsigned char masque = 0x01 << reste;
    unsigned char coleur = (valeur & masque) >> reste;
...
void switchImage() {
    ...
    plogoActuel = (unsigned char*) &TVOlogo2;
